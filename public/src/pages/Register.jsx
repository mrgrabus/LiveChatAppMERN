...
export default function Register() {
  ...
  const handleValidation = () => {
    ...
    if (password !== confirmPassword) {
      toast.error(
        "Šifra i potvrda šifre moraju biti isti.",
        toastOptions
      );
      return false;
    } else if (username.length < 3) {
      toast.error(
        "Ime mora biti duže od 3 karaktera.",
        toastOptions
      );
      return false;
    } else if (password.length < 8) {
      toast.error(
        "Šifra mora biti jednaka ili duža od 8 karaktera.",
        toastOptions
      );
      return false;
    } else if (email === "") {
      toast.error("Email je obavezan.", toastOptions);
      return false;
    }
